...
Figma Console MCP and setup are documented in the Install workflow (install-mcp-setup, install-figma-bridge). For GoDaddy FOSPL Elements: [designer-figma-fospl](../designer-figma-fospl/SKILL.md).
